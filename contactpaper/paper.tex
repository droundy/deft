...
There are \emph{many} such terms, and this could get expensive.
  ...
  weighted densities:
  \begin{align}
    A_{HS} &= \int \left\{ -n_0 \ln\left( 1 - n_3\right)
    ...
    \\
    &= \int \left\{ -\frac{n_2}{4\pi R^2} \ln\left( 1 - n_3\right)
...
\begin{align}
    ...
    +  \frac{2n_1}{1-n_3}
    + \frac{n_2^2 - \mathbf{n}_{V2} \cdot \mathbf{n}_{V2}}{8\pi \left( 1 - n_3 \right)^2}
    \\
    \frac{\delta A_{HS}}{\delta \mathbf{n}_{V2}(\mathbf{r}')} &=
    \frac{2\mathbf{n}_{V1}}{1-n_3}
    + \frac{n_2 \mathbf{n}_{V2}}{4\pi \left( 1 - n_3 \right)^2}
    \\
    \frac{\delta A_{HS}}{\delta R(\mathbf{r}')} &=
...
in contact with this point.  This changes the weighted densities in
the following way---assuming that our point of interest is
$\mathbf{r}$.
\begin{align}
