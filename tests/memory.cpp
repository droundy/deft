...
int main(int, char **argv) {
  ...
  check_a_functional("HardSphereRFFast", ff, potential, 41, 66, 73, 69);
  ...
  check_a_functional("HardSphereNoTensor", ff, potential, 41, 69, 76, 73);
  ...
  check_a_functional("SaftFluid", ff, potential, 38, 55, 59, 55);
