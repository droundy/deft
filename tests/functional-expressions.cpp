...
int main(int, char **argv) {
  ...
  test_expression_type("phi1", phi1.printme(Expression("n")), "Grid");
  test_expression_type("phi1 of double",
                       phi1.printme(Expression("n").set_type("double")), "double");
  ...
  test_expression("n3(double)", n3.printme(Expression("x").set_type("double")),
                  "4.188790204786391*(R*R*R)*x");
  test_expression("n2(double)", n2.printme(Expression("x").set_type("double")),
