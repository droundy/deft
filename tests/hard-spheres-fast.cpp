...
// #include "HardSpheresFast.h"
// #include "IdealGasFast.h"
...
int main(int, char **argv) {
  ...
  */
  ...
  Minimizer psd = Precision(1e-6, MaxIter(20, PreconditionedSteepestDescent(ff, gd, &potential, QuadraticLineMinimizer)));
  potential.setZero();
