...
set size 1.8,1.2          # The first plot (host plot)
set origin 0,0
...
'figs/pressure-298K.dat' u ($3*molperltobohr3):($2*MPatoHtrperbohr3) title 'expt T = 298K' with points ls 3 , \
'figs/pressure-398K.dat' u ($3*molperltobohr3):($2*MPatoHtrperbohr3) title 'expt T = 398K' with points ls 14 , \
'figs/pressure-498K.dat' u ($3*molperltobohr3):($2*MPatoHtrperbohr3) title 'expt T = 498K' with points ls 13 , \
'figs/pressure-598K.dat' u ($3*molperltobohr3):($2*MPatoHtrperbohr3) title 'expt T = 598K' with points ls 15 , \
'figs/pressure-698K.dat' u ($3*molperltobohr3):($2*MPatoHtrperbohr3) title 'expt T = 698K' with points ls 16 , \
