...
\begin{align}
  F_\text{assoc} &=
\end{align}
\textcolor{red}{Look up paper where I got the association functional!}
...
We use a free square-well dispersion function, which has been
demonstrated (CITE) to give a reasonable fit to the equation of
state.  Thus our model interaction has the form:
\begin{equation}
  V(r) = \Theta(r-2 \lambda_\textit{disp} R)
\end{equation}
...
\begin{align}
  F_\text{disp} &=
\end{align}
\textcolor{red}{Cite the paper where I got the dispersion function!}
