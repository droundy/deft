...
The density profile for a slit of size 4.0~nm is shown in Figure~\ref{fig:energy-1D}. Near the interface, there are oscillations around the
...
vapor to liquid between the rods. }
...
for rods of radius 0.5~nm. Since we are looking at only hard-walled
...
(see Figure~\ref{fig:energy-rods}). \needsworknow{More discussion of Figure~\ref{fig:energy-rods}}
...
than 0.9~-~1.0~nm\cite{walther2004hydrodynamic}. This is several times larger than
what we find for hydrophobic rods, as expected due to the carbon-carbon
interations between two nanotubes. 

The density oscillations are very similar to
