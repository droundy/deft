...
values of the lattice spacing resolution. The density oscillations outside a single
...
contact density calculated using the medium resolution is within 3.5\% of the value at
high resolution, while the low resolution contact density is only within 5.1\%. The total
free energy calculations compare much more favorably. The medium resolution is within 
0.5\% and the low resolution is within 1.0\% of the high resolution free energy.
