...
\needsworklater{ We develop a classical density functional theory for
  ...
  to a slit and hydrophobic rods immersed in water.  This functional will be
  the 
...
(Types and models of water summary/review)
...
experimental pressure data from NIST.  }
...
thanthe free energy of the liquid-filled slit. For the range of slit sizes we
...
and entropic energy densities are shown for a slit size of 4.0 nm.}
\label{fig:energy-1D}
\end{figure}
...
\end{center}
\caption{ Energy per length versus slit size for a slab of water with molecules 
constrained to move in one dimension. The last few data points are likely inaccurate
due to the slit separation being very close to the size of the system. \textcolor{red}{
Not sure if this needs to have a bulk energy amount removed to be accurate.}}
