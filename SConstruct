    ...
    for ww in [1.3, 1.5, 2.0, 3.0]:
        for N in [200]:
            env.Command(target = [datadir+"periodic-ww%03.1f-ff%04.2f-N%i-nw-E.dat" % (ww, ff, N),
                                  datadir+"periodic-ww%03.1f-ff%04.2f-N%i-nw-dos.dat" % (ww, ff, N),
            ...
            env.Command(target = [datadir+"periodic-ww%03.1f-ff%04.2f-N%i-flat-E.dat" % (ww, ff, N),
                                  datadir+"periodic-ww%03.1f-ff%04.2f-N%i-flat-dos.dat" % (ww, ff, N),
                                  datadir+"periodic-ww%03.1f-ff%04.2f-N%i-flat-g.dat" % (ww, ff, N)],
                        source = 'square-well-monte-carlo',
            ...
            for kT in [i*.1 for i in range(1,10)] + range(1,10):
                env.Command(target = [datadir+"periodic-ww%03.1f-ff%04.2f-N%i-kT%g-E.dat" % (ww, ff, N, kT),
                                      datadir+"periodic-ww%03.1f-ff%04.2f-N%i-kT%g-dos.dat" % (ww, ff, N, kT),
