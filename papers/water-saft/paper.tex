\documentclass[twocolumn,amsmath,amssymb,jcp]{revtex4-1}
...
\begin{abstract}
We present a modification to our recently published classical
density functional theory for water.  Both the modified and original
functionals reduces to the statistical associating fluid theory with
variable attractive range (SAFT-VR) equation of state in the
homogeneous limit.
%
...
which is dramatically more accurate at interfaces than earlier
approximations.
%
We now incorporate this improved functional into the association term
of our free energy functional for water, which improves the
description of hydrogen bonding.
%
We examine the effect of this improvement by studying the cases of a
hard hydrophobic rods in water.  Our results show that there is a
moderate change in the density profile near a hard rot, and the number
of broken hydrogen bonds is decreased by approximately a factor of
four.  Examination of a hard sphere solute reveals a similarly large
chage in the number of broken hydrogen bonds.
\end{abstract}
\maketitle
