...
\caption{ Density profiles for a water around a single hydrophobic
  rod. The solid red profile is the density using our new functional
...
in water. Unlike the single rod, the number of hydrogen bonds does not appear to increase
linearly with the sphere radii we used. \fixme{When the size of
each rodis increase, the surface area increases proportional to radius.
However, when we increase the radius of each sphere, the surface area
increases as $R^2$.}
