...
Ref.~\citenum{hughes2013classical} uses the association free energy
...
developed in Ref.~\citenum{schulte2012using} to construct an
association free energy functional.

\section{Method}

The classical density functional for water from
Reference~\citenum{hughes2013classical} consists of four terms:
\begin{align}
...
\caption{ Density profiles for a water around a single hydrophobic rod
  ...
  water and the vertical line on the left represents the wall of the rod.}
...
$g_\sigma^\textit{HS}$ from Ref.~\citenum{schulte2012using}, since beyond the
...
\caption{Broken hydrogen bonds per nanometer for hydrophobic rods
  immeresed in water.  The solid red line uses the functional developd
...
\caption{Broken hydrogen bonds for hard spheres immeresed in water.
  ...
  Ref. \cite{hughes2013classical}l.}
