...
In Figure\fixme{deleted} we show the excess chemical
...
the inset of Fig.~\fixme{deleted}, for rods with very
...
Figure~\fixme{deleted}.  The agreement between these
