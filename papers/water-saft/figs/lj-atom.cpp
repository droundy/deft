...
int main(int argc, char *argv[]) {
  ...
  sprintf(datname, "papers/water-saft/figs/lj-%s-%04.2fnm-energy.dat", argv[1], temperature/kB);
  ...
  externalpotential.epsNativeSlice("papers/water-saft/figs/lj-potential.eps",
                                   Cartesian(0,ymax,0), Cartesian(0,0,zmax), 
                                   Cartesian(0,ymax/2,zmax/2));
  printf("Done outputting lj-potential.eps\n");
  ...
  double energy;
  {
    ...
    for (int i=0;i<numiters && min.improve_energy(true);i++) {
      ...
      // density.epsNativeSlice("papers/water-saft/figs/lj-density.eps",
      //                        Cartesian(0,ymax,0), Cartesian(0,0,zmax), 
      //                        Cartesian(0,ymax/2,zmax/2));
    }
    {
  ...
  sprintf(plotname, "papers/water-saft/figs/lj-%s-%04.2f.dat", argv[1], temperature/kB);
