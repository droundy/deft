...
int main(int argc, char *argv[]) {
  ...
  for (distance=0*nm; distance<1.6*nm; distance +=0.05*nm) {
    ...
    potential = new_water_prop.liquid_density*constraint
      + 500*new_water_prop.vapor_density*VectorXd::Ones(gd.NxNyNz);
    ...
    //    //			new_water_prop.liquid_density, 1, " ");
    ...
    //double totalentropy = S.integral(new_water_prop.kT, potential)/width;
