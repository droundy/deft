...
int main(int argc, char *argv[]) {
  ...
  snprintf(datname, 1024, "papers/hughes-saft/figs/four-rods-in-water-%04.1fnm.dat", diameter/nm);
  ...
  for (distance=0.0*nm; distance<=dmax; distance += dstep) {
    ...
    snprintf(plotnameslice, 1024, "papers/hughes-saft/figs/four-rods-%04.1f-%04.2f.dat", diameter/nm, distance/nm);
