...
\begin{figure}
  \includegraphics[width=\columnwidth]{figs/gamma-n500.pdf}
  \caption{The update factor $\gamma$ for N = 500 versus iteration for
  three different methods: WL, SAMC, and SAD.
