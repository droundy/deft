...
$1/\sqrt{t}$~\cite{belardinelli2008analysis}. \davidsays{I don't
  understand the following: An effort to reduce the number of user
  defined parameters of WL and formulate a theory for why the method
  converges despite detailed balance being violated although
  infrequently was also being undertaken.  CUT THIS MAYBE?}
