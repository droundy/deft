...
$\nicefrac{1}{t}$ then the update factor is modified by
$\nicefrac{1}{t}$ and the histogram is no longer tracked. Employing
...
$\nicefrac{1}{t}$~\cite{belardinelli2008analysis}. Zhou et. al further
