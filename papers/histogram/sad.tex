...
a special case of the Stochastic Approximation approach, whose
convergence could be
mathematically proven~\cite{liang2006theory}. In
2007, Liang, Liu, and Carrol et al. argued that WL can be
considered a form of Stochastic Approximation Monte Carlo
(SAMC)~\cite{liang2007stochastic}. \davidsays{I'm here} While
