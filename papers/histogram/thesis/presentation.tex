...
\begin{frame}
  ...
  \begin{figure}
    ...
    \caption{Sample density of states (\only<1>{$N=25$,
        $\eta=0.3$}\only<2>{$N=100$, $\eta=0.1$})}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    ...
    \caption{Sample \only<1>{energy histogram}\only<2>{weight
        array}\only<3>{density of states} ($N=25$, $\eta=0.3$)}
  \end{figure}
\end{frame}
