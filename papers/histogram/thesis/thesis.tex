...
a statistically significant histogram $H\p{R}$, in any reasonable
amount of time.
...
D\p{E}e^{-E/kT}$ dominates the sum in (\ref{eq:XT}).
...
(\ref{eq:dos}) for a weight array $w\p{E}$ which should yield a flat
energy histogram $H\p E=H_0$ to get
\begin{align}
  w\p E=\f1{D\p E},
