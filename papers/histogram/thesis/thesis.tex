...
down-going walker diffusivity at an energy $E$ by $\alpha_+\p{E}$.

The down-going walker flux $j\p{E}$ is defined in terms of the
diffusivity $\alpha_+\p{E}$ by
\begin{align}
  j=\alpha_+\f{dn_+}{dE}.
...
\begin{align}
  j=\alpha_+\sp{n\f{df}{dE}+f\f{dn}{dE}}.
...
\begin{align}
  \int_{f=0}^1\f{df}{j}=\int_{E=E_-}^{E_+}\f{dE}{\alpha_+n}.
...
\begin{align}
  \f1j=\int_{E=E_-}^{E_+}\f{dE}{\alpha_+n}.
