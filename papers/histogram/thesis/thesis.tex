...
\newcommand{\email}{\href{mailto:mika.perlin@gmail.com}{mika.perlin@gmail.com}\xspace}
...
\author for the degree of \underline{\degree} presented on
\date. Title: \underline{\title}.
...
\underline{\degree} project of \author presented on \date.
...
\hrule ~\\
David Roundy, Mentor, representing the Department of Physics

\vspace{1.5cm}

\hrule ~\\
Henri J. F. Jansen, Committee Member, representing the Department of
Physics

\vspace{1.5cm}

\hrule ~\\
David H. McIntyre, Committee Member, representing the Department of
Physics
