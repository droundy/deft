...
% \fixme{In this section I will explain why and how weights work as
% advertised. Essentially, we will consider the effect of weights on a
% two-state system (or on the transitions between two particular
% states in an otherwise multi-state system), and convince ourselves
% that the biasing effect of weights is the identical in an ensemble
% of transitions between any number of states.}
