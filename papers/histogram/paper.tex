...
\begin{figure}
  \includegraphics[width=\columnwidth]{figs/lv/ww1_30-ff0_22-30x4-max-entropy-error.pdf}
  \caption{The average entropy error for each method is shown with
  SAD serving as the `golden'
  standard.}\label{fig:avgS-30x4}
\end{figure}
\begin{figure}
  \includegraphics[width=\columnwidth]{figs/lv/ww1_30-ff0_22-60x8-max-entropy-error.pdf}
  \caption{The average entropy error for each method is shown with SAD serving as
  the `golden' standard.}\label{fig:avgS-60x8}
\end{figure}
\begin{figure}
  \includegraphics[width=\columnwidth]{figs/lv/ww1_30-ff0_22-100x10-max-entropy-error}
  \caption{The average entropy error for each method is shown with
