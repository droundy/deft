...
\begin{equation}
 \mathcal{V}_{\mathcal{DGC}}=\begin{cases} \infty & \lvert\textbf{r}\rvert< \sigma\\-\epsilon & \sigma<\lvert\textbf{r}\rvert<\lambda\sigma\\0 & \lvert\textbf{r}\rvert > \lambda\sigma\end{cases}
\end{equation}
...
There are actually a lot of cool ideas (...which likely won't make it into this paper) I came across in the literature (2013) talks about extrapolating Monte-Carlo to other temperatures and densities along isochors and isotherms.  (2017) talks about taking a Taylor expansion of the macrostate probability and updating in a histogram.  This was applied only to square-well fluid and allowed extrapolation from higher temperatures (at lower computational cost) to lower temperatures (higher computational cost).
