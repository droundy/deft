...
class of Monte-Carlo techniques.

A major advantage of using Histogram methods is that the algorithms give quantatative
estimates for the density of states $\mathcal{D}$(E).  From the density of states,
it is possible to calculate free energies and heat capacities, as well as, other 
thermodynamic variables.

Questions: The advantage of Histogram methods? What information do
