...
\jpsays{It would be good to address why our SAD algorithm is necessary i.e. explain strengths and weaknesses of each method and a brief historical overview of when they were developed.  We should talk about why our awsome method is so good.  Also, we should talk about why we are testing on square-well fluid vs say some other system.}
