...
be the case.  The probabilies of actually observing the system in the old state is given
by
\begin{align}
...
In order to calculate an overal transition probability $\mathcal{P}_{N,\delta}$, we
