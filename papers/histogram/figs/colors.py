...
_colors = { 'sad': 'r',
            ...
            'vanilla_wang_landau-inv-t-50': 'xkcd:electric blue',
            'vanilla_wang_landau-inv-t-50-slow': 'xkcd:hot pink',
            'wl-inv-t-50': 'xkcd:electric blue',
            'wl-inv-t-50-slow': 'xkcd:hot pink',
            'vanilla_wang_landau-inv-t-256': 'xkcd:electric blue',
            'wl-inv-t-256': 'xkcd:electric blue',
            'wl-256': 'k',
            'wl-50': 'k',
            'wl-50-slow': 'k',
            'tmmc': 'b',
            ...
            'samc-1e3-256': 'r',
            'samc-1e4-256': 'tab:orange',
            'samc-1e5-256': 'gold',
            'samc-1e6-256': 'g',
            'samc-1e7-256': 'midnightblue',
            'samc-1e8-256': 'darkmagenta',
            'samc-1e3-50': 'r',
            'samc-1e4-50': 'tab:orange',
            'samc-1e5-50': 'gold',
            'samc-1e6-50': 'g',
            'samc-1e7-50': 'midnightblue',
            'samc-1e3-50-slow': 'r',
            'samc-1e4-50-slow': 'tab:orange',
            'samc-1e5-50-slow': 'gold',
            'samc-1e6-50-slow': 'g',
            'samc-1e7-50-slow': 'midnightblue',
...
_linestyles = {
    ...
    'wl-50': '--',
    'wl-50-slow': '--',
    'vanilla_wang_landau-inv-t-50': '--',
    'vanilla_wang_landau-inv-t-50-slow': '--',
    'wl-inv-t-50': '--',
    'wl-inv-t-50-slow': '--',
    'vanilla_wang_landau-inv-t-256': '--',
    'wl-inv-t-256': '--',
    'samc-1000': ':',
    'samc-10000': ':',
    'samc-100000': ':',
...
_legend_label = {
    ...
    'vanilla_wang_landau-slow': 'WL-slow',
    'vanilla_wang_landau-fast': 'WL',
    'vanilla_wang_landau_C': 'WL-C',
    'vanilla_wang_landau-s2': 'WL-s2',
    'vanilla_wang_landau-inv-t-50': '1/t-WL',
    'vanilla_wang_landau-inv-t-50-slow': '1/t-WL-slow',
    'wl-inv-t-50': '1/t-WL',
    'wl-inv-t-50-slow': '1/t-WL-slow',
    'vanilla_wang_landau-inv-t-256': '1/t-WL',
    'wl-inv-t-256': '1/t-WL',
    'wl-256': 'WL',
    'wl-50': 'WL',
    'wl-50-slow': 'WL',
    ...
    'samc-1e3-256': 'SAMC ($10^{3}$ $t_0$)',
    'samc-1e4-256': 'SAMC ($10^{4}$ $t_0$)',
    'samc-1e5-256': 'SAMC ($10^{5}$ $t_0$)',
    'samc-1e6-256': 'SAMC ($10^{6}$ $t_0$)',
    'samc-1e7-256': 'SAMC ($10^{7}$ $t_0$)',
    'samc-1e8-256': 'SAMC ($10^{8}$ $t_0$)',
    'samc-1e3-50': 'SAMC ($10^{3}$ $t_0$)',
    'samc-1e4-50': 'SAMC ($10^{4}$ $t_0$)',
    'samc-1e5-50': 'SAMC ($10^{5}$ $t_0$)',
    'samc-1e6-50': 'SAMC ($10^{6}$ $t_0$)',
    'samc-1e7-50': 'SAMC ($10^{7}$ $t_0$)',
    'samc-1e3-50-slow': 'SAMC ($10^{3}$ $t_0$)',
    'samc-1e4-50-slow': 'SAMC ($10^{4}$ $t_0$)',
    'samc-1e5-50-slow': 'SAMC ($10^{5}$ $t_0$)',
    'samc-1e6-50-slow': 'SAMC ($10^{6}$ $t_0$)',
    'samc-1e7-50-slow': 'SAMC ($10^{7}$ $t_0$)',
