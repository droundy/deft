...
# np is a particular n, calculated like nl above
## I used prefac = 0.44913 (found by hand at T=276) and nw = 4.9388e-3 (atom/bohr^3; n at STP)
# np is what gets adjusted, rather than prefac
