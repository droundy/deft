...
%% \begin{align}
%%   \begin{split}
%%     \beta F = &{} \beta F_0 + \beta(1 - 0)\left\langle W_N \right\rangle_{\lambda = 0} \\ &{} - \beta\frac{1}{2}(1 - 0)^2\left(\left\langle W_N'(\lambda = 0) \right\rangle_{\lambda = 0} - \beta^2\sigma^2_{\lambda = 0} \right)
%%   \end{split} \\
%%   \begin{split}
%%     =&{}  \beta F_0 + \beta\left\langle W_N \right\rangle_{\lambda = 0} \\ &{} - \beta\frac{1}{2}\left(\left\langle W_N'(\lambda = 0) \right\rangle_{\lambda = 0} - \beta^2\sigma^2_{\lambda = 0} \right) \label{eqn:complicated-HTE}
%%   \end{split}
%% \end{align}
