...
\fixme{Some thoughts:
  \begin{itemize}
    \item Liquids are essential for life
    \item Rust, aqueous environment for biology, etc
    \item Critical point is important for many industries
    \item Square well liquid is a good simple model for liquids
    \item Include lots (or at least plenty) of references
  \end{itemize}
}

The square well liquid is an approximation to simple liquids that is widely used.
