...
#set format y "%3.00g"
set ylabel 'saturated liquid density (1/bohr^3)'
#set ytics 1.0
...
plot [:] [:] \
'figs/equation-of-state.dat' u 1:3 title 'theory' with lines ls 1, \
'figs/experimental-equation-of-state.dat' u 1:3 title 'experiment' with lines ls 2
