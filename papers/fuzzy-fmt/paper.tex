...
simulations of the Barker-Henderson fluid. The results
shown in Figure~\ref{fig:p-vs-V_at_fixed_T} display very good agreement 
for lower densities across all temperatures shown and at higher
...
transition. 
\textcolor{red}{Our theory consistently predicts higher pressures than
...
as is evident from Fig.~\ref{fig:p-vs-V_at_fixed_T}.  
