...
\end{align}
Setting $V_{wca}$ and $V_{erf}$ equal at $r=\alpha$
\begin{align}
  k_BT \ln 2 = 4\epsilon \left[ \left(\frac{\sigma}{\alpha}\right)^{12} -
    \left(\frac{\sigma}{\alpha}\right)^{6} \right] + \epsilon
\end{align}
Solving for $\alpha$ and taking the reasonable solution gives
\begin{align}
  \alpha = \sigma \left( \frac{2}{1 + \sqrt{\frac{k_BT}{\epsilon}
        \ln 2}} \right)^{\frac{1}{6}}.
\end{align}
Next, we set both potential's slopes equal at $r = \alpha$ and find that
\begin{align}
...
\begin{figure}
\begin{center}
\includegraphics[width=3.5in]{figs/p-vs-V}
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics[width=3.5in]{figs/walls-150}
\end{center}
\caption{Density distribution near a hard wall.}
\label{fig:walls-150}
\end{figure}
...
\begin{figure}
  \includegraphics[width=\columnwidth]{figs/soft-walls-50}
