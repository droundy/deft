...
\begin{align}
  f(r) =
  \begin{cases}
    e^{-\gamma V_0 \left( 1 - \frac{r}{r_0} \right)^2} - 1 & 0 \leq r
    \leq r_0 \\
    0 & otherwise.
  \end{cases} 
\end{align}
...
(r) \Theta_2 (R - r)
\end{equation}
where B is a constant to be determined by fitting (stuff) and $R =
...
\begin{align}
f'(r) = \frac{\gamma V_0}{R} \left( 1 - \frac{r}{2R} \right)
              e^{-\gamma V_0 \left( 1 - \frac{r}{2R} \right)^2}
\end{align}
...
\fixme{I was a little unsure of this due to the Theta functions and
integrated from 0 to 2R which gives $1 - \exp(-\gamma V_0)$.}
