...
\begin{abstract}
  ...
  which reproduces the second virial coefficent of the WCA fluid.
...
functions computed using the test-particle approach.  \textcolor{red}{delete?:Results for
reduced densities below $n^* = 0.6$ have been
omitted as they were exact over temperature ranges from $T^*=1$ to
