...
The SFMT free energy functional is constructed so as to yield results 
consistent with the low-density limit of the virial expansion
and with the limiting case of a zero-dimensional cavity.
...
and other temperature-dependent diameters discussed earlier. 
The $\Xi$ parameter is a measure of the effective softness of the 
interaction, and also increases with the temperature. 
