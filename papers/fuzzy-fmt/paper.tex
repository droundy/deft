...
In this paper, we will modify $n_2(\rr)$ to approximate the SFMT
relation in Equation~\ref{eq:mayerandw2}, and utilize the relations in
...
match $V_{erf}$ to the WCA potential. Expanding $V_{erf}(r)$ in a
...
\begin{align}
  \alpha = \sigma \left( \frac{2}{1 + \sqrt{\frac{k_BT}{\epsilon}
        \ln 2}} \right)^{\frac{1}{6}}.
\end{align}
Next, we set both potential's slopes equal at $r = \alpha$ and solve
for $\Xi$ to find
\begin{align}
