...
\begin{align}
  ...
  \left(1 - \frac{\sigma^2}{4R^2}\right) &= \frac{k_BT}{V_0} \\
  \sigma &= 2R\left(1 - \frac{k_BT}{V_0}\right) \\
  a &= ?\frac{k_BT}{V_0}\frac{\sigma}{2R^2} \\
  &= ?\frac{k_BT}{V_0}\left(1 - \frac{k_BT}{V_0}\right)\frac{1}{R} \\
\end{align}
...
\begin{align}
  \tilde{w}_0(k) &= \frac{1}{k}\int_0^\infty
...
\begin{align}
  \tilde{w}_0(k) &= \frac{1}{k}\int_{-\infty}^\infty
  e^{-\frac{(r-\sigma/2)^2}{a^2}} \frac{\sin{kr}}{r}\textrm{dr} \\
