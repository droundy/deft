...
\begin{align}
  d(T) &= \int_0^{\infty or \sigma? CHECK!}\left( 1 - e^{-\beta u(r)} \right)~\mathrm{dr}
...
It is a mean-value thereom, that uses a set of weighted densities $\lbrace{n_i(\vec r)\rbrace}$ 
