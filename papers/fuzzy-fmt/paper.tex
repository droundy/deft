...
\Phi_2 &= \frac{n_1 n_2 - \mathbf{n}_{V1}\mbox{~\scriptsize\textbullet~}\mathbf{n}_{V2}}{1-n_3} \\
...
\begin{align}
  ...
  f(r) &= \tfrac12 \left( \mathrm{erf}\left( \frac{r - \alpha}{\frac{\Xi}{\sqrt{2}}} \right) - 1 \right)
  \label{eq:mayer-approx} \\
  \Verf(r) &= -kT\ln\left[\tfrac12 \left( \mathrm{erf}\left( \frac{r -
    \alpha}{\frac{\Xi}{\sqrt{2}}} \right) + 1 \right) \right].\label{eq:Verf}
\end{align}
