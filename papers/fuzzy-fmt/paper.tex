...
\begin{figure}
\begin{center}
\includegraphics[width=3.5in]{figs/radial-distribution-150}
\end{center}
\caption{Radial distribution function with 1.5 reduced density.}
\label{fig:radial-distribution-150}
\end{figure}
