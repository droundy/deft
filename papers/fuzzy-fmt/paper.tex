...
where we have used the tensor version of $\Phi_3$ formulated by Tarazona~\cite{reference!}.
The integrands are functions of a set of weighted densities $n_{i}(\textbf{r})$ known as \emph{fundamental measures}.
