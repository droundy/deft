...
\begin{align}
  ...
  a &= \frac{4k_BTR^2}{V_0 \sigma \sqrt{\pi}}\\
  &= \frac{2k_BTR}{V_0 \sqrt{\pi \left(1-\frac{k_BT}{V_0}\ln 2 \right)}}
\end{align}
...
\begin{align}
  ...
  \frac{\sigma}{2}\right)\right) ~\textrm{du} \\
  &= \frac{\sqrt{\pi}}{k}e^{-\left(\frac{ak}{2} \right)^2} \sin\left(\frac{k\sigma}{2}\right)
\end{align}
...
have
\begin{align}
  \tilde{w}_0(k) &= \frac{4\sqrt{\pi}}{4\sqrt{\pi}ak}\int_0^\infty
...
\begin{align}
  ...
  \bigg[\int_{-\infty}^{\infty}
    ...
    \sin\left(k(ax+\frac{\sigma}{2})\right) \bigg]\Bigg{\}} \\
  &=\frac{2}{\sigma}\left[\tilde{w}_1(k) - \frac{2}{\sigma} \left(
    \tilde{w}_2(k) - \frac{\sigma}{2}\tilde{w}_1(k)\right)\right] \\
  &=\frac{4}{\sigma}\left[\tilde{w}_1(k) -
    \frac{1}{\sigma}\tilde{w}_2(k) \right]
\end{align}
