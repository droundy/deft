...
\begin{align}
    \frac{\Xi}{\sqrt 2}= \sqrt{(\langle r^2\rangle-\left<r\right>^2)} 
\end{align}
\davidsays{maybe square each side?} where
\begin{align}
    \langle r\rangle = \frac{\int f'_{wca}(r)~r~d\vec r}{\int f'_{wca}(r)~d\vec r}
\end{align}
\davidsays{confirm that this is a vector integral} and 
\begin{align}
