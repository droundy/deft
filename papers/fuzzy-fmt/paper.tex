...
\begin{abstract}
  ...
  fluid. Our model incorporates temperature-dependent parameters associated
  with both the length-scale and effective softness of the interaction,
