...
\begin{align}
  u(r) &= \bigg\epsilon\bigg(\frac{r}{R_m}\bigg)^{-n}
\end{align}
...
Longuet-Higgens~\cite{?} to take into account the change of molecular size on the 
free energy of a conformal assembly.

Inspired by Rowlinson's work~\cite{?}, Barker-Henderson generalized the method.
...
hard sphere diameter to model a soft, repulsive potential given by~\cite{?}
