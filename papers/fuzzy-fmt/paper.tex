...
IT AS A REFERNCE FLUID.  However, the hard-sphere fluid remains a
...
FIXME make this flow right.  FMT first?

SFMT is a classical Density Functional 
theory (cDFT) that directly treats soft repulsive potentials in a framework
