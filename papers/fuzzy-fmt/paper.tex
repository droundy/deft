...
\begin{figure}
  \begin{center}
    %\includegraphics[width=\columnwidth]{figs/soft-walls}    UNCOMMENT THIS WHEN WOKRING!
...
\begin{figure}
 \begin{center}
  \includegraphics[width=\columnwidth]{figs/Phasediagram_T-vs-n}
 \end{center}
\caption{Phase Diagram of the reduced termperature verses the reduced density.}
\label{fig:Phasediagram_T-vs-n}
\end{figure}

\begin{figure}
 \begin{center}
  \includegraphics[width=\columnwidth]{figs/Phasediagram_P-vs-T}
 \end{center}
\caption{Phase Diagram of the reduced pressure verses the reduced temperature.}
\label{fig:Phasediagram_P-vs-T}
\end{figure}
