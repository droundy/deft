...
\begin{equation}
     w_1(r)=\frac{w_2(r)}{4{\pi}r}=\frac{1}{4{\pi}r}\frac{\sqrt{2}}{\Xi\sqrt{\pi}}e^{-\left(\frac{r-\frac{\alpha}{2}}{\frac{\Xi}{\sqrt{2}}}\right)^2}
\end{equation}
\begin{equation}
...
\begin{equation}
     w_2(r)=\frac{\sqrt{2}}{\Xi\sqrt{\pi}}e^{-\left(\frac{r-\frac{\alpha}{2}}{\frac{\Xi}{\sqrt{2}}}\right)^2}
\end{equation}
