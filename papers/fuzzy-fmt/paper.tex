...
We start by discussing the soft sphere radial distribution
function. Results for reduced densitied below $n^* = 0.60$ have been
...
\fixme{underestimate} the peaks. Comparison with the
Barker-Henderson results shows our DFT to have similar error to the
