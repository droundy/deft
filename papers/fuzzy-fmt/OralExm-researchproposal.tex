...
$\bullet$ Demonstrated good agreement between our WCA fluid and experiments with Argon \\

\section{Part 3: Research To Do}
\noindent Toward a better model and a better understanding of our model, I propose to: \\
$\bullet$ Find the internal energy for our WCA fluid model \\
$\bullet$ Improve results at low temperature, high density \\ %pressure calculations  \\
