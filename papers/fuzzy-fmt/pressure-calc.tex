...
%\end{align} 
\begin{align}
    \mu(\vec r) &=  \frac{1}{V}\frac{\delta F[n(\vec r)]}{\delta n(\vec r)}\bigg|_{T,V}  
\end{align}
and the average chemical potential over all space is
\begin{align}
    \mu &= \left<\mu(\vec r)\right> = \frac{1}{V}\int \mu(\vec r)~d\vec r~\\
        &= \frac{1}{V^2} \int \frac{\delta F[n(\vec r)]}{\delta n(\vec r)}
           \bigg|_{T,V}~d\vec r~  
...
\end{align} 
For a spatially varying number density, the ideal free energy becomes
\begin{align}
...
\end{align}
\begin{align}
 \mu_{ideal}(\vec r) &= \frac{1}{V}\frac{\delta F[n(\vec r)]}{\delta 
              n(\vec r)}\bigg|_{T,V} \\ \nonumber\\
    &= \frac{1}{V}\frac{\delta}{\delta n(\vec r)}
    \left(k_BT\int d\vec r~'~ n(\vec r~')\left[\ln\left(\frac{n(\vec r~')}
    {n_Q}\right)-1\right]\right) \\ \nonumber\\
    &= \frac{k_BT}{V}\int d\vec r~'~ \frac{\delta}{\delta n(\vec r)}\left(n(\vec r~')\left[\ln\left(\frac{n(\vec r~')}
    {n_Q}\right)-1\right]\right) \\ \nonumber\\
    &= \frac{k_BT}{V}\left(\int d\vec r~'~ \frac{\delta n(\vec r~')}
    ...
    \right)\\ \nonumber\\
    &= \frac{k_BT}{V}\int d\vec r~'~ \frac{\delta n(\vec r~')}
    {\delta n(\vec r)}\left(\ln\left(\frac{n(\vec r~')}
    {n_Q}\right)-1 + 1\right)\\ \nonumber\\
    &= \frac{k_BT}{V}\int d\vec r~'~ \frac{\delta n(\vec r~')}
    {\delta n(\vec r)}\ln\left(\frac{n(\vec r~')}
    {n_Q}\right)\\ \nonumber\\
    &= \frac{k_BT}{V}\int d\vec r~'~ \delta(\vec r~'-
    \vec r)\ln\left(\frac{n(\vec r~')}
    {n_Q}\right)\\ \nonumber\\
    &= \frac{k_BT}{V}\ln\left(\frac{n(\vec r)}
    {n_Q}\right)  \text{WRONG! should not have V}
    %p. 64 EQ 3.1.20 Simple Liquids
\end{align}
