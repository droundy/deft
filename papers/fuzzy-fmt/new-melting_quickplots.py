...
#for gwidth in [.1, .2, .3, .4, .5, .6, .7, .8, .9, 1]: 
#for gwidth in [.2]: 
    #os.system('time figs/new-melting.mkdat --kT %g --n %g --d %s_kT%g_n%g_gw%g_dx%g --fvstart 0 --fvend .8 --fvstep 0.2 --gw %g  --dx %g --mc 800' % (kT, n, directory, kT, n, gwidth, dx, gwidth, dx))
...
#for fv in [0]:
    os.system('time figs/new-melting.mkdat --kT %g --n %g --d %s_kT%g_n%g_fv%g_dx%g --fv %g --gwstart .01 --gwend .1 --gwstep .005 --dx %g --mc 800' % (kT, n, directory, kT, n, fv, dx, fv, dx))
    ##os.system('time figs/new-melting.mkdat --kT %g --n %g --d %s_kT%g_n%g_fv%g_dx%g --fv %g --gwstart .38 --gwend .48 --gwstep .005  --dx %g' % (kT, n, directory, kT, n, fv, dx, fv, dx))
