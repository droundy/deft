...
#with comand ./plot-phasediagram.py [Optional: --tensor]  >> phasedata.dat (or phasedata-tensor.dat)
...
for kT in np.arange(0.05, 1.25, 0.05):
   ...
   print (kT, p_inter, 1/invnh, 1/invnc)   #This print out is sent to >> phasedata.dat (or phasedata-tensor.dat) to store for reference
