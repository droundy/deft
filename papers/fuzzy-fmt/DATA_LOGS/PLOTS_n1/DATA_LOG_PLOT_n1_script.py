...
#    print MC[i]
#    data_file="DATA_LOGS/PLOTS_n1/DATA_LOG_PLOT_n1_MC"+str(MC[i])+".dat"
...
if custom > 0 :
  ...
  plot_name="DATA_LOGS/PLOTS_n1/plot_DATA_LOG_"+name_me    #FILL IN NAME
...
if cFEpervol > 0 :
  ...
  plt.plot(thisdata_n1_800[:,0], thisdata_n1_800[:,4], label = 'cFEperVol_MC800')
  plt.plot(thisdata_n1_8000[:,0], thisdata_n1_8000[:,4], label = 'cFEperVol_MC8000')
  plt.plot(thisdata_n1_80000[:,0], thisdata_n1_80000[:,4], label = 'cFEperVol_MC80000')
  plt.plot(thisdata_n1_800000[:,0], thisdata_n1_800000[:,4], label = 'cFEperVol_MC800000')
  ##plt.plot(thisdata_n1_8000000[:,0], thisdata_n1_8000000[:,4], label = 'cFEperVol_MC8000000') #won't plot one point?
  plot_name="DATA_LOGS/PLOTS_n1/plot_DATA_LOG_cCEpervol"
...
if cphi_1 > 0 :
  ...
  ##plt.plot(thisdata_n1_8000000[:,0], thisdata_n1_8000000[:,1], label = 'cphi_1_MC8000000') #won't plot one point?
  plot_name="DATA_LOGS/PLOTS_n1/plot_DATA_LOG_cphi1"
...
if cphi_2 > 0 :
  ...
  ##plt.plot(thisdata_n1_8000000[:,0], thisdata_n1_8000000[:,2], label = 'cphi_2_MC8000000') #won't plot one point?
  plot_name="DATA_LOGS/PLOTS_n1/plot_DATA_LOG_cphi2"
...
if cphi_3 > 0 :
  ...
  ##plt.plot(thisdata_n1_8000000[:,0], thisdata_n1_8000000[:,3], label = 'cphi_3_MC8000000') #won't plot one point?
  plot_name="DATA_LOGS/PLOTS_n1/plot_DATA_LOG_cphi3"
...
if MC400 > 0 :
  ...
  plt.plot(thisdata_n1_400[:,0], thisdata_n1_400[:,2], label = 'cphi_2_MC400')
  plt.plot(thisdata_n1_400[:,0], thisdata_n1_400[:,3], label = 'cphi_3_MC400')
  plot_name="DATA_LOGS/PLOTS_n1/plot_DATA_LOG_MC400_cphi123"
...
if MC800 > 0 :
  ...
  plt.plot(thisdata_n1_800[:,0], thisdata_n1_800[:,2], label = 'cphi_2_MC800')
  plt.plot(thisdata_n1_800[:,0], thisdata_n1_800[:,3], label = 'cphi_3_MC800')
  plot_name="DATA_LOGS/PLOTS_n1/plot_DATA_LOG_MC800_cphi123"
...
if MC8000 > 0 :
  ...
  plt.plot(thisdata_n1_8000[:,0], thisdata_n1_8000[:,2], label = 'cphi_2_MC8000')
  plt.plot(thisdata_n1_8000[:,0], thisdata_n1_8000[:,3], label = 'cphi_3_MC8000')
  plot_name="DATA_LOGS/PLOTS_n1/plot_DATA_LOG_MC8000_cphi123"
...
if MC80000 > 0 :
  ...
  plt.plot(thisdata_n1_80000[:,0], thisdata_n1_80000[:,2], label = 'cphi_2_MC80000')
  plt.plot(thisdata_n1_80000[:,0], thisdata_n1_80000[:,3], label = 'cphi_3_MC80000')
  plot_name="DATA_LOGS/PLOTS_n1/plot_DATA_LOG_MC80000_cphi123"
...
if MC800000 > 0 :
  ...
  plt.plot(thisdata_n1_800000[:,0], thisdata_n1_800000[:,2], label = 'cphi_2_MC800000')
  plt.plot(thisdata_n1_800000[:,0], thisdata_n1_800000[:,3], label = 'cphi_3_MC800000')
  plot_name="DATA_LOGS/PLOTS_n1/plot_DATA_LOG_MC800000_cphi123"
...
if MC8000000 > 0 :
  ...
  plot_name="DATA_LOGS/PLOTS_n1/plot_DATA_LOG_MC8000000_cphi123"
