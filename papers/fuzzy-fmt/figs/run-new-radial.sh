...
rq run -J radiallj-6-10 --mem 88 -o new-data/radial-lj-0.71-0.83890.out ./new-radial-lj.mkdat 0.83890 0.71 
rq run -J radiallj-6-5 --mem 88 -o new-data/radial-lj-2.48-0.957.out ./new-radial-lj.mkdat 0.957 2.48     
rq run -J radiallj-6-2.5 --mem 88 -o new-data/radial-lj-wca-1.235-0.5844.out ./new-radial-lj.mkdat 0.5844 1.235  
rq run -J radiallj-6-1 --mem 88 -o new-data/radial-lj-2.48-1.095.out ./new-radial-lj.mkdat 1.095 2.48     


#Run new-bh-radial-lj.cpp
rq run -J radialbh-lj-6-10 --mem 88 -o new-data/radial-bh-lj-0.71-0.83890.out ./new-bh-radial-lj.mkdat 0.83890 0.71
rq run -J radialbh-lj-6-5 --mem 88 -o new-data/radial-bh-lj-2.48-1.095.out ./new-bh-radial-lj.mkdat  1.095 2.48     
rq run -J radialbh-lj-6-2.5 --mem 88 -o new-data/radial-bh-lj-wca-1.235-0.5844.out ./new-bh-radial-lj.mkdat 0.5844 1.235  
