...
over-structuring\cite{lin2009importance, wang2011density,
  mogelhoj2011ab, jonchiere2011van}.  It has also been found that
...
feasible only for a very small number of water molecules. A more
...
We construct a new classical density functional for water by treating
each individual water molecule as a purely
classical hard sphere and adding association terms based on SAFT. Water
is unlike simple fluids (which are mainly defined by van der Waals
forces and weak electrostatic interations) because it requires direct
treatment of association effects. The strong 
hydrogen bonds and polar
interactions in water are ideal for describing with SAFT, which was designed for
use with hydrogen-bonding fluids.
