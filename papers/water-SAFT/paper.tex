...
water~\cite{ding1987, Yang1992, yang1994density, gloor2002saft, 
  gloor2004accurate, gloor2007prediction, Jaqaman2004, chuev2006, clark2006developing,
...
much longer range, in agreement with our results.  \fixme{Please read
  this carefully, as I did some major changes.  I took a look at the
  paper, and it seems that in Figure 3c (and the paragraph that ends
  at the top of that page) they finally do a truly hydrophobic
  interaction, which is a better comparison with what we did.  The
  drying transition is inhibited by the attraction between tube and
  water. }
