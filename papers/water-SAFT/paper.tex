...
Using classical DFT, we aim to find an equation of state for water
that describes interactions qualitatively and gives accurate
quantitative results within a reasonable temperature range without
needing extensive paramaterization.
...
attractive sites. This model applied to give equation of state for
various systmes and can be applied to inhomogeneous fluids.
