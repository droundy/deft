...
carbon-water interactions.  \fixme{Can you (Jess or Eric) double-check
  what the excluded-volume diameter is for them? The discrepancy we
  describe in the text is actually the opposite of what I would
  expect, but looking at the plot, I see something that is the
  opposite of what is described in the text.  We should really figure
  this out, and probably spend another phrase or two clarifying why it
  is the direction we expect.}
