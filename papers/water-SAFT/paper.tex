...
surface value.  For very small radius (less than about 0.1~nm) the
relationship between the free energy per area and radius is linear,
with the slope required by the contact-value theorem (see Equation~\ref{contactvaluethm}).
