...
\jeffsays{I'm confused by this next part.  Are we just saying that
  instead of using our published $g_{\sigma}$ we could have used a
  Carnahan Starling derived $g_{\sigma}$? Don't understand why that
  would add an unnecessary step in using g(r).}
