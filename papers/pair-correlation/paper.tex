...
distances $r_{12} \le \maxrfit R$.  This range of distances is relevant to
...
$g_\sigma$ at contact and to reproduce $g(r)=1$ in the low-density
($g_\sigma =1$) limit.  Incorporating these constraints we have the
functional form:
\begin{align}
  g_S(r,g_\sigma) &=
