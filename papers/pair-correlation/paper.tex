...
\begin{equation}
  \begin{split}
    ...
    p = \frac{1+\eta+\eta^2-\eta^3}{(1-\eta)^3}\Longrightarrow \left(\frac{\partial p}{\partial V}\right)_T = \frac{dp}{d\eta}\frac{d\eta}{dV}\\
    \eta = \frac{4\pi R^3N}{3V}\Longrightarrow \frac{d\eta}{dV} = -\frac{\eta}{V}\\
    \left(\frac{\partial p}{\partial V}\right)_T = -\frac{\eta}{V}\left[\frac{1 + 2\eta - 3\eta^2}{(1-\eta)^3} + 3\frac{1 + \eta + \eta^2 - \eta^3}{(1-\eta)^4}\right]\\
...
\begin{figure}
  ...
  \caption{The triplet distribution function
    $g^{(3)}(\rr_1,\rr_2,\rr_3)$ plotted when $\rr_1$ and $\rr_2$ are
    in contact.}\label{fig:triplet-distribution-4}
\end{figure}
...
\begin{figure}
  ...
  \caption{The triplet distribution function
    $g^{(3)}(\rr_1,\rr_2,\rr_3)$ plotted when $\rr_1$ and $\rr_2$ are
    separated by the diameter of one sphere.}\label{fig:triplet-distribution-3}
\end{figure}
\begin{figure}
  \includegraphics[width=\columnwidth]{figs/triplet-correlation-pretty-inbetween-4.pdf}
  \caption{The triplet distribution function
    $g^{(3)}(\rr_1,\rr_2,\rr_3)$ plotted when $\rr_1$ and $\rr_2$ are
    separated by the diameter of one sphere.}\label{fig:triplet-distribution-4}
\end{figure}
