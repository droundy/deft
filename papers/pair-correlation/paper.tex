...
\begin{figure}
  \includegraphics[width=6cm]{figs/pair-correlation-2-395-5}
  \caption{Plot of the pair distribution function near a hard wall.
    How do we plot this?}\label{fig:pair-distribution}
\end{figure}

\section{How well does it work?}
Figure~\ref{fig:dadz} shows...
\begin{figure}
  \includegraphics[width=3cm]{figs/dadz-3-2}
  \includegraphics[width=3cm]{figs/dadz-3-3}
