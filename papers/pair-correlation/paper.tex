...
\begin{figure}
  \includegraphics[width=\columnwidth]{figs/triplet-correlation-alt-3.pdf}
  \caption{The triplet distribution function
    $g^{(3)}(\rr_1,\rr_2,\rr_3)$ plotted when $\rr_1$ and $\rr_2$ are
    in contact.}\label{fig:triplet-distribution-3}
\end{figure}
\begin{figure}
  \includegraphics[width=\columnwidth]{figs/triplet-correlation-alt-4.pdf}
  \caption{Pretty plot of the pair distribution function near a hard
    wall.}\label{fig:triplet-distribution-4}
\end{figure}
...
\begin{multline}
    ...
    + \mathop{\mathop{\sum_{i<j}}_{k<}}_{kl \ne ij}
...
\begin{multline}
  ...
  \Theta(r_{ij}-\sigma) \\
  + \mathop{\mathop{\sum_{k<l}}_{m<n}}_{kl\ne mn}
...
\begin{multline}
  ...
  N^2\iiiint \Theta(\sigma+\delta-r_{12})
...
\begin{multline}
  ...
  \shoveleft{\quad= nN \int_{\sigma}^{\sigma+\delta} g(r) d\rr }
  - \frac{n^2N}{2} \left(\int_{\sigma}^{\sigma+\delta} g(r)
  d\rr\right)^2
  \\
  + \frac{n^3N}{6} \left(\int_{\sigma}^{\sigma+\delta} g(r)
  d\rr\right)^3 + \cdots
  \label{eq:zdiff-g}
\end{multline}
