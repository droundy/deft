...
free energy in powers of a small parameter, which is typically the
product of a
...
which is an integral of a simple convolution in three dimensions.  Thus,
...
function from Monte Carlo simulation.  We chose to focus our fit on
