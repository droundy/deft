...
CVA once again underestimates the oscillations on the left-hand
...
compares favorably with the other approximations.  This is
...
\begin{figure}
  ...
  \caption{Plot of $\frac{dF_1}{dz}$ near a hard wall.  (a) shows a
    ...
    \davidsays{Probablyt cut out inverse sixth?}
...
from Eq.~\ref{eq:da1} for the square-well fluid.  This potential
stresses the CVA, since the edge of the attraction occurs at the dip
in the radial distribution function at this density, with poor results
for the bulk fluid.  \davidsays{The last sentence is inaccurate.}  We
see that over these length scales, both the CVA and Sokolowski's
approximation are very accurate.  Finally, in the case of the
power-law attraction all approximations tested work very well.
...
\davidsays{Probably cut the long-range attractions.}
