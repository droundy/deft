...
at contact, when the distance between $\rr_1$ and $\rr_2$ is a hard-sphere
diameter.
...
\begin{figure*}
  ...
  \caption{ \paircaption{0.1} \fixme{Fix *ALL* plots to specify units of distance $x/R$.}
...
from Monte Carlo.  On the right, we display \fixme{this needs to be finished...}
