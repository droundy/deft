...
\begin{figure}
  ...
  \caption{Plot of the hard-sphere radial distribution function with our
    separable fit.  The solid lines show the radial distribution function,
    $g(r)$, from MC simulations and the dashed lines show our separable fit
    to the radial distribution function,
