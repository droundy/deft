...
functionals \fixme{introduce DFT first} have been based on the
...
\fixme{explain a bit of perturbation theory here?}
...
\begin{figure}
  \begin{tikzpicture}
    \node[anchor=south west,inner sep=0] at (0,0) {\includegraphics[width=\columnwidth]{figs/pair-correlation-pretty-alt-1.pdf}};
    \draw [decorate, decoration = {brace, mirror, raise=0.5cm}]
    (4.75, .75) node(a){} -- (5.95, .75) node(b){};
    \draw [decorate, decoration = {brace, mirror, raise=0.5cm}]
    (5.99, .75) node(a){} -- (7.83, .75) node(b){};
  \end{tikzpicture}
...
\begin{figure}
  \begin{tikzpicture}
    \node[anchor=south west,inner sep=0] at (0,0) {\includegraphics[width=\columnwidth]{figs/pair-correlation-pretty-alt-2.pdf}};
    \draw [decorate, decoration = {brace, mirror, raise=0.5cm}]
    (4.75, .75) node(a){} -- (5.95, .75) node(b){};
    \draw [decorate, decoration = {brace, mirror, raise=0.5cm}]
    (5.99, .75) node(a){} -- (7.83, .75) node(b){};
...
\begin{figure}
  \begin{tikzpicture}
    \node[anchor=south west,inner sep=0] at (0,0) {\includegraphics[width=\columnwidth]{figs/pair-correlation-pretty-alt-3.pdf}};
    \draw [decorate, decoration = {brace, mirror, raise=0.5cm}]
    (4.75, .75) node(a){} -- (5.95, .75) node(b){};
    \draw [decorate, decoration = {brace, mirror, raise=0.5cm}]
    (5.99, .75) node(a){} -- (7.83, .75) node(b){};
...
\begin{figure}
  \begin{tikzpicture}
    \node[anchor=south west,inner sep=0] at (0,0) {\includegraphics[width=\columnwidth]{figs/pair-correlation-pretty-alt-4.pdf}};
    \draw [decorate, decoration = {brace, mirror, raise=0.5cm}]
    (4.75, .75) node(a){} -- (5.95, .75) node(b){};
    \draw [decorate, decoration = {brace, mirror, raise=0.5cm}]
    (5.99, .75) node(a){} -- (7.83, .75) node(b){};
