...
Methfessel predicts the pair distribution function only at contact,
...
convolution kernel depends on both points.  This limits the accuracy.
...
\begin{figure}
  ...
  \includegraphics[width=\columnwidth]{figs/dadz-2-3.pdf}
