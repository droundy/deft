...
\begin{document}
\title{The contact value approach for the pair distribution function of the inhomogeneous hard-sphere
  fluid}
...
\begin{figure}
  ...
  \caption{Plot of the hard-sphere radial distribution function, with
    our short-range separable
    fit.}\label{fig:short-range-radial-distribution}
\end{figure}
...
averaged in Eq.~\ref{eq:CVA} give equal contributions to the integral:
\begin{align}
