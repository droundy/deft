...
\begin{figure*}
  ...
  \caption{ \paircaption{0.1} \fixme{Do we want to label the y-axis for the 1d plots?}
...
\begin{figure*}
  ...
  \caption{\fixme{Tweak spacing, add a, b, c, etc. The 1d plots still have two curves for this work, do we want to remove one?} The triplet distribution function
...
\begin{figure}
  ...
  \caption{Plot of $\frac{da_1}{dz}$ near a hard
    wall.\fixme{Do we want y-axis ticks or no? Also, why does the data start
      at $z = 0$?}}
  \label{fig:dadz}
\end{figure}
