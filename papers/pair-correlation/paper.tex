...
One common approximation \cite{gloor2007prediction,
  gross2009density,osborn1980monotonic,mccoy1981comparison,barrett2006some}
assumes a mean-density approximation for the pair distribution
function:
\begin{align}
...
approximation~\cite{fischer1980born,harris1987comment,wadewitz2000application,winkelmann2001liquid}:
\begin{align}
