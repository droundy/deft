...
my $dd;
foreach $dd ([30,655, 0.1], [30,1327, 0.2], [30, 2009, 0.3], [30, 2699, 0.4], [30, 3379, 0.5]) {
    ...
    my $outfilename = "$dir/mc/wallsMC-triplet-$ff";
    my $command = "./pair-monte-carlo $N $iters $acc $outfilename periodxyz $len flatdiv triplet innerSphere 1.0";
