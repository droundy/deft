...
\begin{figure}
  \includegraphics[width=\columnwidth]{figs/periodic-ww130-ff30-N100-E}
...
\begin{figure}
  \includegraphics[width=\columnwidth]{figs/periodic-ww130-ff30-N100-weights}
  \caption{The weight functions from different methods.}
\end{figure}

\begin{figure}
  \includegraphics[width=\columnwidth]{figs/periodic-ww130-ff30-N100-dos}
...
\begin{figure}
  \includegraphics[width=\columnwidth]{figs/periodic-ww130-ff30-N100-u}
  \caption{Specific internal energy.\label{fig:u}}
\end{figure}

\begin{figure}
  \includegraphics[width=\columnwidth]{figs/periodic-ww130-ff30-N100-hc}
  \caption{Specific heat capacity.\label{fig:hc}}
\end{figure}

\begin{figure}
  \includegraphics[width=\columnwidth]{figs/periodic-ww130-ff30-N100-rdf}
