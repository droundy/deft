...
foreach $dd (#[20,832], [20,1718], [20,2629], [20,3543], [20,4475],
             [16,430], [16,1880]#, [16,891], [16,1370], [16,2375],
...
foreach $dd ([20,195], [20,816]#, [20,390], [20,605], [20,1020],[24,1320],[24,1650]
    ) {
...
foreach $dd ([2,24,332], [2,24,1320], #[2,24,1647], [2,24,659], [2,24,987],
             [6,32,764], [6,32,3055]#, [6,32,1528], [6,32,2291]
    ) {
