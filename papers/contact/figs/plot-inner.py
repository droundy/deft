...
r_mc = mcdata[:,0]
n_mc = mcdata[:,1]
off = 1/2 # 0 = huge or tiny? 1 = large or medium? etc
...
A_plt.plot(r[r>=showrmin]/2,gA[r>=showrmin],"ro--",markevery=me,label="$g_\sigma^A$ (White Bear)")
...
S_plt.plot(r[showrmin<=r]/2,gS[showrmin<=r], "go--",markevery=me,label="$g_\sigma^S$ (White Bear)")
