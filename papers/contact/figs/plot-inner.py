...
A_plt.plot(r_mc,gA_mc,"r-",label="$r_\sigma^A$ (MC)")
...
S_plt.plot(r[showrmin<=r],gS[showrmin<=r], "go--",markevery=me,label="$g_\sigma^S$ (White Bear)")
#S_plt.plot(r_2[showrmin<=r_2],gS_2[showrmin<=r_2], "g.--",markevery=me,label="$g_\sigma^S$ (White Bear mark II)")
