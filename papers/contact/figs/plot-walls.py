...
n_plt.plot(dftdata[:,0]/2+offset,dftdata[:,1]*4*numpy.pi/3,"m--",label='$n$ DFT')
...
A_plt.plot(dftdata[start_here:stop_here,0]/2+offset,dftdata[start_here:stop_here,5],"ro-",markevery=me,label="$g_\sigma^A$ (White Bear)")
