...
n_plt.plot(dftdata[:,0]+offset,n0*4*numpy.pi/3,"c-.",label="$n_0$")
n_plt.plot(dftdata[:,0]+offset,nA*4*numpy.pi/3,"m--",label="$n_A$")
...
A_plt.plot(dftdata[start_here:stop_here,0]+offset,dftdata[start_here:stop_here,5],"ro-",markevery=me,label="$g_\sigma^A$ (White Bear)")
...
S_plt.plot(dftdata[start_here:stop_here,0]+offset,dftdata[start_here:stop_here,3],
           "go--",markevery=me,label="$g_\sigma^S$ (White Bear)")
