...
set terminal postscript eps enhanced color "Helvetica" 20 size 6,4
set output 'figs/box-110c--05,05,05-14.eps'
...
splot [:] [:] [:] \
'figs/box-110c--05,05,05-14.dat' u ($2*sqrt(2)):3:4 notitle with pm3d
