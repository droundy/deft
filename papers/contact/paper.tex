...
\begin{align}
  ...
  &= k_BT n g_\sigma
\end{align}
Since we are interested in the correlation function at the surface at
which hard spheres contact, we need to compute the pressure on that
surface.   This pressure can be
...
\begin{align}
  p_\sigma(\mathbf{r}) &= \frac{1}{n(\rr) 4\pi \sigma^2}\frac12 \frac{\delta
