...
the pressure on the spheres, we need to divide by half the total
...
straightforward, if tedious, and we will write no more about it.  The
functional derivatives of the fundamental measures, however, require a
bit more subtlety, and we will address them here.  We note that
\textcolor{red}{still working on this...}
