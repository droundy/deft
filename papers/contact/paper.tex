...
\section{Asymmetrically averaged correlation function}\label{contact-at-sphere}
...
\section{Symmetrically averaged correlation function}
...
fact, the density of such spheres is just the density $n_0(\xx)$ from
...
Section~\ref{sec:yuwu}, although they use a modified density $\zeta
n_0$ to account for density gradients.
...
\begin{align}
  ...
  g_\sigma^\text{Yu} &= \frac{1}{1-n_3}
    ...
    \\
  g_\sigma^\text{Yu,S} &= \frac{\frac{1}{1-n_3}
    + \frac12 \frac{R n_2\zeta}{(1-n_3)^2}
    + \frac1{18} \frac{R^2 n_2^2 \zeta}{(1-n_3)^3}}{\zeta^2}
\end{align}
