...
\subsection{Hard spheres around a hard sphere (or rod)}

\textcolor{red}{
  It would also be interesting to study a system with opposite
  curvature.  Put a (larger) hard sphere in the hard-sphere fluid, and
  see what the contact density is around that hard sphere.  This
  touches on an important limiting case...
}
