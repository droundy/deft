...
\begin{figure}[h!]
    \centering
     %\includegraphics[height=7cm]{MaxwellDTC-Fig1.pdf}
...
and the partitian function can be expressed as
...
\begin{equation}{\label{Fidealmultipleint}}{=-k_BT\ln\left(\frac{1}{h^{3}}\int{d\vec{p}_1}~e^\frac{-\frac{|\vec{p}_1|^2}{2m}}{k_BT}\frac{1}{h^{3}}\int{d\vec{p}_2}~e^\frac{-\frac{|\vec{p}_2|^2}{2m}}{k_BT}{...}\frac{1}{h^{3}}\int{d\vec{p}_N}~e^\frac{-\frac{|\vec{p}_N|^2}{2m}}{k_BT}\right)}\end{equation}
...
Multiplying by $\frac{V}{V}$ gives an expression in terms of the number density $n=\frac{N}{V}$ gives \begin{equation}{F_{ideal}= k_BT\left[\frac{N}{V}\ln{\left(\frac{N\Lambda^3}{V}\right)}-\frac{N}{V}\right]}V\end{equation}
...
%which becomes \begin{equation}{F_{excess}=-k_BT\ln{\left(1+ \frac{1}{2}\frac{N(N-1)}{V^{N}}V^{N-2}\int{...}\int{dQ}{f_{ij}} + .....\sum_{i\neq{j}\neq{k}\neq{l}}{f_{ij}f_{kl}} +\sum_{i\neq{j}\neq{k}\neq{l}\neq{m}\neq{n}}{f_{ij}f_{kl}f_{mn}} +...\right)}}\end{equation}% 
...
\begin{equation}{F_{excess}=-k_BT\ln{\left(e^{\frac{1}{2}\frac{N^2}{V}\int{f(r)}{d\vec{r}}}\right)}}\end{equation} \begin{equation}{F_{excess}=-k_BT\frac{1}{2}\frac{N^2}{V}\int{f(r)}{d\vec{r}}}\end{equation}  %\begin{equation}{F_{excess}=k_BT\frac{N^2}{V}\left(-\frac{1}{2}\int{f(r)}{d\vec{r}}\right)}\end{equation}%
