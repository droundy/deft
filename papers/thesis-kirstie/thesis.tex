...
In 1961 Morita and Hiroike introduced a density functional approach to finding an expression for the 
excess Helmholtz free energy of inhomogeneous fluids~\cite{MoritaDFT}.
% ?  Percus-Yevick applied Density Functional Theory (DFT) to find an expression for the excess 
