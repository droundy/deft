...
\begin{figure}[h!]
    \centering
    \includegraphics[height=6cm]{P-T_Diagram.pdf}
...
\begin{equation}{\sum_{i=1}^N\left(\frac{|\vec{p}_i|^2}{2m}\right)}\end{equation}
...
owever, a rotated coordinate system $(x',y',z')$ is used which is 
