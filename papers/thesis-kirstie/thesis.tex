...
The goal of this project is to generate temperature-density and 
pressure-temperature phase diagrams for a Weeks-Chandler-Anderson (WCA) 
model fluid using a computer program. 
...
%coexistence which exists between the liquid and crystal states, and which 
%consists of various amounts of liquid and crystal existing together,
...
%at the boundaries of the coexistance region for a given temperature from 
%which the phase diagrams can be constructed.
%end save
%
...
which consists of an ideal part and an excess part ,
...
In this paper, classical Density Functional Theory (cDFT)
will be used to find the equilibrium Helmholtz free energy, and 
Soft Fundamental Measure Theory (SFMT) will be used to form the functional for the excess Helmholtz 
free energy. 
%to predict the freezing of a Weeks-Chandler-Anderson 
...
%
%Classical Density Functional Theory (cDFT) is used to find the equilbrium 
According to classical Density Functional Theory (cDFT) the equilbrium 
Helmholtz free energy of the system 
can be found
by varying the number density profile $n(\vec{r})$ until the free energy 
is minimized. 
%The minimum free energy, and its corresponding number 
%density profile are then the equilibrium values of the Helmholtz free energy
%of the system at the given temperature and number density. 
%
%To find the Helmholtz free energy both the ideal Helmholtz free energy
%and the excess Helmholtz free energy must be found and added together.
...
%or atoms that make up the fluid. 
%
%The excess Helmholtz free energy is that 
%additional energy beyond the ideal Helmholtz free energy which results from the presence of an interatomic potential 
...
%
Soft Fundamental Measure Theory (SFMT) makes the task of forming an expression
%is a method used to form an expression 
...
%without 
%having to take explicitly into account the interaction each sphere, or atom, 
%has with every other sphere which would make the task very difficult, 
%or even prohibtive.
%
...
%which is known as the Weeks-Chandler-Anderson model fluid. f
%
...
% like that exhibited by a WCA fluid. 
%
...
%The Helmholtz free energy excess free energy is then added to the ideal free energy calculated 
%analytically to find the resulting free energy for the system. 
Soft Fundamental Measure Theory (SFMT) is used to form the expression 
...
but it must be taylored to fit a particular fluid. 
...
%-------Antithetic-------------------
%In order to further reduce the error 
