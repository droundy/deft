...
Equation~\ref{w2_w3_relation}, which is a step function for the Hard-sphere fluid.
...
There are four scalor weight functions, two vector weight functions, and 
...
Schmidt's proposed erf model~\cite{schmidt2000fluid} designed to model a steep, 
...
to implement computionally. $\Xi$ is determined by setting the second virial 
coeficeint $B_2$ of the error function potential $V_{erf}(r)$ and of the
WCA potential equal.  
...
while the other is erronesously lower than it should be.
