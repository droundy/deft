...
a functional for the Helmholtz free energy was formed by adding 
the ideal and the excess portions of the free 
energy.
\begin{equation}{F[n(\vec{r})]=F_{ideal}[n(\vec{r})] + F_{excess}[n(\vec{r})]}\end{equation}
...
forming an expression difficult. 
...
In order to use classical Density Functional Theory, a functional for 
the excess Helmholtz free
