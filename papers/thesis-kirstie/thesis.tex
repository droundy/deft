...
\abstract{
  ...
  $\Xi$ is found by making the second virial coefficient for the error 
  function potential equal to the second virial coefficient for the WCA 
  potential. Our functional was successful in predicting the freezing of 
  the WCA fluid with a fairly good match to Monte-Carlo simulations. 
...
goes instantly to infinity when contact is made. The inability to push 
...
the same pressure at a phase transition.
...
freezing can be found from identifying the inverse densities at which the 
...
The pressure at the transition point can be obtained from the point of 
...
the slope and corresponding y-intercept data collected from lines tangent 
...
he excess partitian function $Z_{excess}$ accounts for the interaction 
of all the atoms according to their interatomic potential. The free energy 
can also be broken into two parts using Equation~\ref{Zmultiply} giving
