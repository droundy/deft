...
\section{Deconvolution of the Hard-Sphere Mayer Function} 
...
\begin{align} \label{leftside}
    F.T.\left(\frac{\Theta(|\vec{r}|-2R)}{2}\right) 
      ...
      \label{leftside-solved} &= \frac{4\pi}{k^3}\sin (kR)\cos (kR) - \frac{4 \pi R}{k^2}\cos^2 (kR) + \frac{4\pi R}{k^2} \sin^2 (kR)
\end{align}
...
\end{align}
which equals Equation~\ref{leftside-solved}, and so
%\begin{align}
