...
\subsection{Model Fluids and the Weeks-Chandler-Anderson Fluid (WCA)}
...
\end{equation} 
where the parameter $\alpha$ is derived by setting the erf potential equal to the WCA potential when r equals $\alpha$ 
