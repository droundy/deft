...
additional energy which results from the presence of an interatomic potential 
...
Soft Fundamental Measure Theory (SFMT) is a method used to form an expression 
for the excess Helmholtz free energy of a particular model fluid without 
having to take explicitly into account the interaction each sphere, or atom, 
has with every other sphere. 
