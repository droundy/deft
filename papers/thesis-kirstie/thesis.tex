...
\begin{figure}[h!]
    ...
    for $r<{2R}$ where R is the radius of a hard sphere (which is 
...
\begin{align}{\mu_L=\mu_S\mbox{~~~~and~~~~}P_L=P_S\mbox{~~~~at a phase transition}}\end{align} 
...
The slope gives the negative of the pressure, and the corresponding
y-intercept gives the chemical potential. The 
curves in Figure~\ref{fig:GibbsvsP} consist of a collection of data 
points (P,~$\mu$) for the liquid and the solid respectively.
...
\begin{figure}[h!]
    ...
    \caption{The liquid and solid densities at the phase transistion are 
...
And so over time the free energy settles to a minimum. 
...
\end{align}
  ...
  \begin{figure}[h!]
    ...
    are shown in red. At low densities only the interactions shown in 
    green are considered, since atoms are not likely to be clustered.}
...
occupied by the spheres divided by the total volume avaliable, 
