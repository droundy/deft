...
\abstract{
  ...
  using Soft Fundamental Theory (SFMT) Schmidt's error function model 
  in which we have incorporated temperature dependent parameters to make
  %$\alpha$ and $\Xi$. We find $\Xi$ by making the second virial 
  %coefficients of the error function potential and the WCA potential equal. 
  the second virial coefficient correct. Our functional was 
...
FMT was developed 
by Rosenfeld~\cite{rosenfeld1989, rosenfeld1994,fmtfromsptandsignerror}, 
