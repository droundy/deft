...
%\begin{frame}{Monte-Carlo Integration}
   %\begin{columns}
		...
		%\end{block}
	    %\column{.65\textwidth}
	    %\includegraphics[height=4cm]{InclusionRadius}
   %\end{columns}
%\end{frame}
...
%\begin{frame}{Monte-Carlo Integration}
	%\begin{columns}[t]
		...
		%\column{.5\textwidth}
		 %\begin{figure}
            %\centering
            %\includegraphics[width=1.02\columnwidth]{InclusionRadius}
...
%\begin{frame}{Gaussians in a primitive cell}
    %\begin{figure}
       %\centering
       %\includegraphics[height=5cm]{InclusionRadius}
...
\begin{frame}{Conclusions and Further Research}
          ...
          \begin{block}{Further work}
            ...
            %\item Combine with a functional for an attractive potential?
