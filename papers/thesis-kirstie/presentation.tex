...
%   \end{block}
  \begin{block}{Fundamental Measure Theory (FMT)} 
       \begin{itemize}
           \item DFT for hard spheres developed by Rosenfeld
...
\begin{frame}{Our weighting function}
    \begin{itemize}
        \item All the weighting functions are derived from $w_2(r)$
    ...
    %   \end{align}
      \item and adjust FIXME parameters to approximate the above...
    \end{itemize}
    %\small
    %\begin{align}\label{eq:Fexfunctional}
