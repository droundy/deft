...
%\begin{frame}{Monte-Carlo Integration}
   %\begin{columns}
		...
		%\end{block}
	    %\column{.7\textwidth}
	    %\includegraphics[height=4.5cm]{InclusionRadius.png}
	    %\small
	    %$~~~~~$ Crystal Cell with Gaussians at lattice sites
	    %\normalsize
   %\end{columns}
%\end{frame}
...
\begin{frame}{Classical Density Functional Theory (cDFT)}
    ...
    \end{itemize}   
    \vspace{+1em}
       $~~~~$NEXT: Construct phase diagrams %using (f,$\frac{1}{n}$) data for each temperature to find P, $\text n_L, \text n_S$  at phase transitions.
       %Collect (f,$\frac{1}{n}$) data for each temperature T
       %to use in Maxwell's Double Tangent Construction 
       ...
       %\vspace{-2em}
        ...
        \begin{block}{Created an array of number density profiles to model crystal}
           \begin{itemize}
              ...
              \item Consists of a sum of Gaussian distributions %centered at lattice sites
...
%\begin{frame}{}
	%\begin{columns}[t]
        ...
        %\begin{figure}
            %\centering
            %\includegraphics[width=0.4\columnwidth]{PrimitiveCellLightBlue}
...
%\begin{figure}
       %\centering
       %\includegraphics[height=4cm]{Simple_cell}
       %A simplified cell
 %\end{figure} 
%\end{frame}
...
%\begin{frame}{}
    ...
    %\begin{figure}
       %\centering
       %\includegraphics[height=2cm]{Ensemble_Gaussian}
...
%\begin{frame}{}
    ...
    %\begin{figure}
       %\centering
       %\includegraphics[height=2cm]{Ensemble_Smallcells}
       %%\caption{On the left are shown four examples of possible positions 
...
%\begin{figure}
   %\centering
   %\includegraphics[height=2cm]{SameStatPic}
