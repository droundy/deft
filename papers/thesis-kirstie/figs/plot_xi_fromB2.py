...
zeta_2pt=(pow(2,1.0/6)-alpha(KbT))/1.8 #Xi_new_2pt
...
#Plot df/dr and w2*w2 for comparison--------------------- - Figure 4
...
# #Potential Plot - Figure 5
# #r=np.linspace(.6, 1.1225, 2000)   #2R=1.1225  shows intersection
# #r=np.linspace(.8, 1.1225, 2000)   #2R=1.1225  
# r=np.linspace(.95, 1.1225, 2000)   #2R=1.1225  
...
# V = 4*epsilon*(sigma_over_r_to_pow6*sigma_over_r_to_pow6 - sigma_over_r_to_pow6) + epsilon
# #plt.plot(r/sigma,V/epsilon, label='Vwca', color='black')
# plt.plot(r/sigma,V/KbT, label='Vwca/kT', color='black')

# #Plot Verf/T with Xi from B2
# Verf=-KbT*np.log(.5*(special.erf((r-alpha)/zeta_B2)+1))
# #plt.plot(r/sigma,Verf/epsilon, label='B2', color='blue')
# plt.plot(r/sigma,Verf/KbT, label='Verf/kT', color='blue')
...
#Potential Plot at various temperatures - Figure 6
#r=np.linspace(.6, 1.1225, 2000)   #2R=1.1225  shows intersection
#r=np.linspace(.8, 1.1225, 2000)   #2R=1.1225  
#r=np.linspace(.95, 1.1225, 2000)   #2R=1.1225   good
