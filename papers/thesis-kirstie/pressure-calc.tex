...
%%            
           %&= \frac{k_BT}{V}\int  \frac{\left[n_1(\vec r')
           %\pi(\Xi^2 + \alpha^2)+n_2(\vec r')\left(\frac{\alpha}{2}\right)\right]
           %\left(1-n_3(\vec r')\right)}{(1-n_3(\vec r'))^2} 
          %\nonumber \\
          %&+ \frac{\left[n_1(\vec r')n_2(\vec r')-\vec n_{v1}(\vec r')
          %\cdot \vec n_{v2}(\vec r')\right]}{(1-n_3(\vec r'))^2}
          %\left(\frac{\pi\Xi^2\alpha}{2}\right)  ~d\vec r' \\
%%            
           %&= \frac{k_BT}{V}\int \left(n_1(\vec r')\pi(\Xi^2 + \alpha^2)  
          %+n_2(\vec r')\left(\frac{\alpha}{2}\right)\right)\left(1-n_3(\vec r')\right)
          %+ \left(n_1(\vec r')n_2(\vec r')-\vec n_{v1}(\vec r')
          %\cdot \vec n_{v2}(\vec r')\right)\left(\frac{\pi\Xi^2\alpha}{2}\right)
          %\frac{1}{(1-n_3(\vec r'))^2} ~d\vec r'
\end{align}
...
%\begin{align}
    %\widetilde{w}_0(k=0)=\frac{\sqrt{\pi}}{\sqrt{2}k\Xi}e^{-\left(
