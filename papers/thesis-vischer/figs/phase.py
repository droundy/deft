...
l1y = [x**2 for x in l1x]

l2x = np.arange(t[0], t[0]+.5, .01)
l2y = [x*20 -20+t[0] for x in l2x]

l3x = np.arange(t[0], c[0], .01)
l3y = [2*(x-t[0])**2 +t[1] for x in l3x]
...
ax.text(.5, 2.5, 'S', fontsize= 28)
ax.text(1.25, 1.75, 'L', fontsize=28 )
ax.text(1.75, .75, 'G', fontsize=28 )
ax.text(2, 2, 'F', fontsize=28)
