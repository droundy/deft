...
\begin{frame}{Why is separation important?}
		\begin{columns}[t, onlytextwidth]
			...
			\end{itemize}
			\column{.5\textwidth}
			Statistical Associating Fluid Theory % seg is HS + dispersion (SW/LJ), chain is covalent bonds, assoc is hydrogen bonds
			\begin{align*}
...
\begin{frame}
	\begin{itemize}
		\item<1-> 
			...
			\end{align*}
		\item<2-> %Since $E = K + V$, with $N$ particles: 
			\begin{align*}
