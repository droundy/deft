...
\begin{align}
    ...
    \label{C-S-eq}  
\end{align} 
where $\eta$ is the filling fraction. The Carnahan-Starling equation of state is an excellent approximation for low-density hard spheres. Close to solidification, near $\eta_{freeze} \approx .5$, this equation of state fails. Thankfully, we are only concerned with filling fractions slightly or significantly below this value, and so the Carnahan-Starling equation of state is an invaluable tool.\\ \ignore{BLAH}
...
\begin{figure}[H]
\centering
    \includegraphics[width=.75\textwidth]{Fexc-vs-T.pdf}
    \caption{Preliminary results for excess specific free energy as a function of temperature with each quantity scaled by well depth $\epsilon$. The vertical line at $T/\epsilon = 0.3$ is the lowest temperature at which our statistics are trustworthy.}
    \label{F-T}
\end{figure}
...
\begin{figure}
\centering
    \includegraphics[width=.75\textwidth]{Shs-vs-eta.pdf}
...
\begin{figure}
\centering
    \includegraphics[width=.75\textwidth]{Uexc-vs-eta.pdf}
...
\begin{figure}
\centering
    \includegraphics[width=.75\textwidth]{Fexc-vs-eta.pdf}
    \caption{Preliminary results for free energy as a function of density. Solid line represents first doubling regime, [more]}
    \label{F-eta}
\end{figure}
