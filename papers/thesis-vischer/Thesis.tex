...
Using the well-established model of the square-well fluid, we seek to determine the applicability of a particular generalized renormalization-group formalism (``GRG'') to find the absolute Helmholtz free energy of systems near criticality.\\
...
\end{align}
where $\beta =  T^{-1}$ and $E_i$ is the energy of the $i^{\text{th}}$. Of course, it is typically impractical to sum over the individual states of the system, especially if there are expected degeneracies. Instead we sum over energies:
\begin{align}
...
\end{align}
At a specified volume and number of particles, the ideal gas contribution is constant. Consequently, for a given temperature we only need to calculate the excess free energy. 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                            METHODS                                  %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}
    ...
    \label{U-eta}
\end{figure}
We see in Figure~\ref{U-eta} that the excess internal energy, as we would expect, becomes more negative as the density increases. The lower the temperature, the more ``clumped'' the system becomes, resulting in lower internal energies.
