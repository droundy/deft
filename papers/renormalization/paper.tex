...
\begin{figure}
  ...
  \caption{Interactions between neighboring subdivisions.}\label{fig:interactions}
\end{figure}
...
Fig.~\ref{fig:interactions}, these interactions can be seen as
a sum of interactions between neighboring subdivisions, combined with
a many-body correction due to ``corner'' interactions.
