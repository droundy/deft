...
\begin{align}
  F_j(N_1\cdots N_8) &= \summicrostatesofoctants
       e^{-\beta E_{i_1\cdots i_8}^{(j)}}
\end{align}
...
\fixme{I have now ``defined'' the terms used by Forte in his
...
\item \fixme{Establish what $g_{N_1\cdots N_8}$ is.}
  ...
  \end{align}
  This combinatoric term ends up showing up as the ideal gas free
  energy term.
